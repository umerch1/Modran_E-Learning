              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    We're on a mission to transform online education and make
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Founded in 2020, EduLearn started with a simple idea:
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2">
              <div className="flex flex-col space-y-4">
                ...
                <p className="text-muted-foreground">
                  Our founders, a group of educators and technologists,
                  recognized the limitations of traditional education systems.
                  They envisioned a platform that could break down barriers to
                  learning and provide high-quality education to anyone with an
                  internet connection.
                </p>
                <p className="text-muted-foreground">
                  What began as a small collection of courses has grown into a
                  comprehensive learning platform with thousands of students
                  worldwide.
                </p>
              </div>
              <div className="flex flex-col space-y-4">
                ...
                <p className="text-muted-foreground">
                  We believe that education is a fundamental right and that
                  technology can democratize access to knowledge. Our vision is
                  to create a world where anyone, regardless of their background
                  or circumstances, can learn new skills, advance their career,
                  and achieve their full potential.
                </p>
                <p className="text-muted-foreground">
                  We're committed to continuous innovation and improvement,
                  always striving to provide the best learning experience
                  possible.
                </p>
              </div>
            </div>
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                <CardContent className="flex flex-col items-center space-y-2 p-6">
                  ...
                  <p className="text-center text-muted-foreground">
                    Striving for the highest quality in all our courses and
                    content.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="flex flex-col items-center space-y-2 p-6">
                  ...
                  <p className="text-center text-muted-foreground">
                    Fostering a supportive environment for learners and
                    instructors.
                  </p>
                </CardContent>
              </Card>
